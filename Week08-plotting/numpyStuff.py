...
# Write a program that makes a list, called salaries, that has 10 random
# numbers (20000 - 80000).

import numpy as np

# it is a good idea to have your absolute values
# set into variables at the beginning of your program
